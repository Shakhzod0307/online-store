    ...
    <div class="card" >                
        ...
        <div class="card-body p-3">
            <div class=""row>
                ...
                @if(Auth::user()->name=='Shahzod')
                    @if($p->sold==0)
                    <a href="{{route('product.buy',$p->id)}}"><button type="button" value="1" name="sold" class="btn btn-primary btn-sm btn-block">Add to My Product</button></a>
